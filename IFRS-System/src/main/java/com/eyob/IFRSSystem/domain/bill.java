...
public class bill {
    ...
    public bill(String bill_id, Date created, Date updated, String terms, Double amount_due, Double amount_paid, Double amount_receivable, Double amount_unearned, Double amount_earned, boolean paid, Date paid_date, Date date, Date due_date, boolean aVoid, Date void_date, boolean progressible, Double progress, String bill_number, String xref, String cash_account_id, String earnings_account_id, String ledger_id, String payable_account_id, String receivable_account_id, String vendor_id) {

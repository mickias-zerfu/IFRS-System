...
public class BillandInvoiceController {
    ...
    public void logeduser(String entity_id, Principal principal, Model model) {
        ...
        for (com.mikiyas.IFRSSystem.domain.entity entity : entityRepository.findAll()) {
    ...
    private String getAll(@PathVariable("entity_id") String entity_id, Model model, Principal principal) {
        ...
        for (bill bill : billRepository.findAll()) {
            if (bill.getBill_id().contains(entity_id)){
                for(com.mikiyas.IFRSSystem.domain.vendor vendor: vendorRepository.findAll()){
...
class repo {
    ...
    public repo(com.mikiyas.IFRSSystem.web.cf cf, com.mikiyas.IFRSSystem.web.ce ce, com.mikiyas.IFRSSystem.web.fp fp, com.mikiyas.IFRSSystem.web.ie ie) {
        this.ce = ce;
        this.fp = fp;
        this.ie = ie;
        this.cf = cf;
    ...
    public com.mikiyas.IFRSSystem.web.cf getCf() {
        return cf;
    }

    public void setCf(com.mikiyas.IFRSSystem.web.cf cf) {
        this.cf = cf;
    }

    public com.mikiyas.IFRSSystem.web.ce getCe() {
        return ce;
    }

    public void setCe(com.mikiyas.IFRSSystem.web.ce ce) {
        this.ce = ce;
    }

    public com.mikiyas.IFRSSystem.web.fp getFp() {
        return fp;
    }

    public void setFp(com.mikiyas.IFRSSystem.web.fp fp) {
        this.fp = fp;
    }

    public com.mikiyas.IFRSSystem.web.ie getIe() {
        return ie;
    }

    public void setIe(com.mikiyas.IFRSSystem.web.ie ie) {
        this.ie = ie;
    }
}
